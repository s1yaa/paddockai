...
export const metadata = { title: "Circuits — PaddockAI" };
export default function CircuitsPage() {
  return <StubPage title="Circuits" icon={<MapPin size={20} className="text-red" />} phase={9} desc="Circuit intelligence: historical driver/constructor performance, circuit fit scores, sector analysis, and overtaking difficulty ratings." />;
}
