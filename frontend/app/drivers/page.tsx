...
export const metadata = { title: "Drivers — PaddockAI" };
export default function DriversPage() {
  return <StubPage title="Drivers" icon={<Users size={20} className="text-red" />} phase={9} desc="Per-driver intelligence pages: championship probability, recent form, circuit performance, wet-weather rating, and teammate comparison." />;
}
