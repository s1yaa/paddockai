...
export const metadata = { title: "Historical Replay — PaddockAI" };
export default function HistoricalReplayPage() {
  return <StubPage title="Historical Replay" icon={<Rewind size={20} className="text-red" />} phase={10} desc="Time machine: select any past race and prediction stage. Reconstruct exactly what data was available then, generate a prediction, and compare against the actual result." />;
}
