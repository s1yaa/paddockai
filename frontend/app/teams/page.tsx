...
export const metadata = { title: "Teams — PaddockAI" };
export default function TeamsPage() {
  return <StubPage title="Teams" icon={<Factory size={20} className="text-red" />} phase={9} desc="Detailed team profiles: staff, base location, engine supplier, historical season performance, and head-to-head statistics." />;
}
