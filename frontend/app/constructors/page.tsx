...
export const metadata = { title: "Constructors — PaddockAI" };
export default function ConstructorsPage() {
  return <StubPage title="Constructors" icon={<Building2 size={20} className="text-red" />} phase={9} desc="Constructor intelligence: race/qualifying pace, DNF rate, pit stop performance, reliability metrics, and championship trajectory." />;
}
